...
resource_files:
  - '../man/figures/pgs_scoring_file.svg'
---
...
knitr::include_graphics('../man/figures/pgs_scoring_file.svg') 
```
...
Each scoring file contains variant identification, effect alleles and respective score weights. The file is formatted as a gzipped tab-delimited text file, with a header containing brief metada about the score.
